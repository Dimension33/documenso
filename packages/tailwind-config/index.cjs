  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // D2DHQ red ramp. Token name kept as `documenso` so we don't have to
        // sweep ~80 component files that reference `bg-documenso-500`,
        // `text-documenso-700` etc. — visually this is now D2DHQ red,
        // semantically it remains the project's "brand accent" palette.
        documenso: {
          DEFAULT: '#8B1A1A',
          50: '#FBEEEE',
          100: '#F7DDDD',
